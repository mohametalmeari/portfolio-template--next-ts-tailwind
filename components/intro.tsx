  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full justify-center outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10"
          href="/CV.pdf"
          download
        >
          Download CV
